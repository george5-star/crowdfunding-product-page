const ProjectStatistics = () => {
  return (
    <div className="container mx-auto -mt-12 bg-neutral-white p-10 rounded-lg max-w-3xl">
      <div className="flex lg:flex-row flex-col items-center text-center lg:justify-start lg:space-x-12">
        <div className="lg:border-e-2 border-neutral-off-white  lg:pe-12">
